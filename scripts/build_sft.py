...
Usage::
    ...
    python scripts/build_sft.py \\
        --source swarmandbee/ml-hack-sessions \\
        --target swarmandbee/ml-hack-sft \\
        --days 7
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--source", default="swarmandbee/ml-hack-sessions")
    ap.add_argument("--target", default="swarmandbee/ml-hack-sft")
    ap.add_argument(
        "--days",
        type=int,
        default=1,
