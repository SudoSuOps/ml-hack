#!/usr/bin/env python3
"""Backstop sweeper for orphan ml-hack sandbox Spaces.
...
A Space is considered an orphan ml-hack sandbox iff ALL hold:
...
def is_sandbox_fork(space) -> bool:
    """Filter: matches the ml-hack sandbox naming pattern.
