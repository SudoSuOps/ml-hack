...
def test_load_config_applies_slack_user_defaults_from_env(tmp_path, monkeypatch):
    ...
    monkeypatch.delenv("ML_HACK_CLI_CONFIG", raising=False)
    monkeypatch.setattr(
        config_module,
...
def test_load_config_merges_user_config_before_env_substitution(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("ML_HACK_CLI_CONFIG", str(user_config_path))
    monkeypatch.setenv("ML_HACK_SLACK_NOTIFICATIONS", "0")
...
def test_slack_user_defaults_can_be_disabled(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("ML_HACK_SLACK_NOTIFICATIONS", "false")
    monkeypatch.setenv("SLACK_BOT_TOKEN", "xoxb-test")
    monkeypatch.setenv("SLACK_CHANNEL_ID", "C123")
