...
``ML_HACK_LIVE_LLM_TESTS=1`` plus the relevant provider key are set.
...
LIVE_TESTS_ENABLED = os.environ.get("ML_HACK_LIVE_LLM_TESTS") == "1"
...
def _skip_without_live_flag() -> None:
    if not LIVE_TESTS_ENABLED:
        pytest.skip("set ML_HACK_LIVE_LLM_TESTS=1 to run paid live LLM tests")
